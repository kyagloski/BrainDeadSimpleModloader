...
2. **Mod Loading**: When launching the game or clicking the **"Load Mods"** button, all files from the staging directory are symlinked to your game's `Data` directory. Symlinking is key here because it is orders of mangitude faster than copying files around.
